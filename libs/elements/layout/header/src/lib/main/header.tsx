            ...
            <div className={`mx-auto w-full md:block md:w-auto ${menuOpen ? 'text-center' : 'hidden'}`} id="navbar-multi-level">
                <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 rounded-lg bg-opacity-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    <li className='py-2 px-3'>
                        <Link href="/home" className={`py-2 px-3 rounded ${pathname === '/home' ? 'text-white bg-pink-800' : 'text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-pink-800 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent'}`}>Home</Link>
                    </li>
                    <li className='py-2 px-3'>
                    ...
                    <li className='py-2 px-3'>
                        <Link href="/shop/product/new" className={`py-2 px-3 rounded ${pathname === '/shop/product/new' ? 'text-white bg-pink-800' : 'text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-pink-800 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent'}`}>Admin</Link>
                    </li>
                </ul>
            </div>
            <Link href='/cart'>
