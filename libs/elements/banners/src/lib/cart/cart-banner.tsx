...
export function CartBanner(props: CartBannerProps) {
  ...
  return (
    <div className='min-h-screen justify-center items-center bg-gray-50'>
      <div className="min-h-screen items-center justify-center flex flex-col pt-32">
      ...
      <div className="container pt-12 mx-auto flex flex-col md:flex-row w-full">
      { CartData.length > 0 ? (<div className="w-full md:w-2/3 min-h-80 md:mx-8">
           {CartItems} 
        </div>) : <EmptyCart/> }
